...
def save_results(src_path, tgt_path, frame_ctr, output_dir, preds):
    """
        Save the results.
    """
...
if __name__ == "__main__":
    ...
    frame_ctr = 0
    for frame in frame_generator(src_path):
        frame_ctr += 1
        swapper.swap_setup(frame, tgt_path)
        ...
        if opt.save_res:
            ...
            save_results(src_path, tgt_path, frame_ctr, pred_output_dir, preds)
